...
def unified_query_demo():
    ...
    result_lotus = engine_lotus.query_ast(backend_free_query)
    ...
    result_docetl = engine_docetl.query_ast(backend_free_query)
    ...
    result_palimpzest = engine_palimpzest.query_ast(backend_free_query)
